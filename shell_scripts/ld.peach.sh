...
#SBATCH --job-name=ld.peach                        # Job name
...
#SBATCH --output=ld_peach_chr4_ld%j.log                        # Standard output and error log
...
all_bam=$work_dir/peach.bam.list
results=$work_dir/Results3
##
angsd -b $all_bam -ref $REF -out $work_dir/Results3/peach -uniqueOnly 1 -remove_bads 1 -only_proper_pairs 1 -trim 0 -C 50 -minMapQ 20 -minQ 20 -minInd 48 -setMinDepth 15 -doCounts 1 -GL 2 -doGlf 2 -doMajorMinor 1 -r HiC_scaffold_4:44720000-44728000 -doGeno 3 -doPost 2 -doMaf 1
##
NGSLD=/nobackup/beegfs/workspace/ks575/Data/Myzus/Myzus_mapping/Trimmed_Resequencing_Data_18_03_2019/ANGSD/Tools/ngsLD
$NGSLD/ngsLD --geno $results/peach.beagle.gz --pos $results/peach.pos.gz --probs --n_ind 48 --n_sites 6952 --max_kb_dist 0 --n_threads 64 --out $results/peach.ld
##
